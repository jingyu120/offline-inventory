            ...
            >
              ...
              {!isDesktop && (
                ...
                >
                  ...
                  >
                    <Text variant="body" fontSize={12} color="primaryText">
                      🌐 {t('language')}
                    </Text>
                    <Text
                      variant="body"
                  ...
                  <Pressable
                    onPress={() => {
                      ...
                      const nextIndex =
                        (states.indexOf(thermalState) + 1) % states.length;
                      const nextState = states[nextIndex];
                      ThermalGuard.setThermalState(nextState);
                      showToast(
                        `${t('thermalState') || 'Thermal State'}: ${nextState}`,
                        nextState === 'SERIOUS' || nextState === 'CRITICAL'
                          ? 'warning'
                          : 'success',
                      );
                    }}
