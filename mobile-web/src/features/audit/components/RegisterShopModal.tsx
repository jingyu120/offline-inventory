...
export const RegisterShopModal: React.FC<RegisterShopModalProps> = ({
  ...
  const handleRegionChange = (regId: string) => {
    ...
    // Default coords based on region
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      console.log('[RegisterShopModal] Successfully created shop:', newShop);
      onRegister(newShopId);
      onClose();
    } catch (e: any) {
      console.error('[RegisterShopModal] Failed to insert new shop:', e);
            ...
            {step === 1 && (
              <Box mb="m">
                <Text variant="body" fontWeight="bold" mb="m">
                  Enter Client Profile Information:
                </Text>
                <TextField
                ...
                <Text variant="caption" color="secondaryText" mb="xs">
                  Optional Coordinates (Autofilled by Territory)
                </Text>
                <Box flexDirection="row" justifyContent="space-between">
                  <Box flex={1} mr="s">
                    <TextField
                      label="Latitude"
                      placeholder="e.g. 16.78"
                      value={latitude}
